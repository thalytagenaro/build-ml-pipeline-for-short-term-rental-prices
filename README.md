...
## Project links
- [Git Repository](https://github.com/thalytagenaro/build-ml-pipeline-for-short-term-rental-prices)
- [Weights and Biases Project](https://wandb.ai/thalyta/nyc_airbnb?workspace=user-thalyta)
